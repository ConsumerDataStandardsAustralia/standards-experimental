...
- 	**Customer**:
    -   The authorising customer that is authenticated by a Data Holder. A Customer is considered to be an "Online Customer" or an "Offline Customer" for the purposes of authentication.
-   **Authentication Provider**: 
    - A Data Recipient or Data Holder that provides Customer authentication. 
...
A customer that is an eligible consumer according to the CDR Rules which has at least one account set up in such a way that it can be accessed online.

For Data Holders in the banking sector, Schedule 3 Part 2.1 applies. For Data Holders in the energy sector, an online customer is an elgible consumer that has at least one account that can be accessed online.

**Offline Customers**  

A customer according to the CDR Rules, who, to be eligible, does not require any accounts to be set up in such a way that they can be accessed online.

A customer that is an eligible consumer according to the CDR Rules but does not have any accounts set up in such a way that they can be accessed online.
